...
@section('content')
<!-- Form -->
<form action="/mutasiscrap" method="get" class="container-fluid px-5 py-2" id="myform">
  <div class="head-form">
    <div class="row">
      ...
      <div class="nav-table px-1">
        <div class="row d-flex">
          ...
          <div class="col-md-6 text-end">
            <button type="submit" class="btn btn-danger" formaction="exportpdfscrap" formtarget="_target"><i class="fas fa-print"></i><span> Print</span></button>
            <button type="submit" formaction="exportexcelscrap" class="btn btn-success"><i
